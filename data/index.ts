...
export const COINS: ICoin[] = [
  ...
  { label: "ADA/USDT", value: "adausdt", Icon: Star, multiply: "60x", min: 0.1, max: 3.5 },
  ...
  { label: "LINK/USDC", value: "linkusdc", Icon: Link2, multiply: "20x", min: 0.02, max: 30.0 },
  { label: "MATIC/USDT", value: "maticusdt", Icon: Hexagon, multiply: "20x", min: 0.1, max: 2.5 },
];